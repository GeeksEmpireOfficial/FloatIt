...
public class Category_Unlimited_Nfc extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, final int startId) {
        ...
        final String className = Category_Unlimited_Nfc.class.getSimpleName();
                        ...
                        if (floatingView != null) {
                            ...
                            if (floatingView[intent.getIntExtra("startId", 1)].isShown()) {
                                try {
                                    ...
                                    PublicVariable.floatingCounter = PublicVariable.floatingCounter - 1;
                                    PublicVariable.floatingCategoryCounter_nfc = PublicVariable.floatingCategoryCounter_nfc - 1;
                                    ...
                                    if (PublicVariable.floatingCategoryCounter_nfc == 0) {
                                        if (broadcastReceiver != null) {
                                            try {
                                                unregisterReceiver(broadcastReceiver);
                                            } catch (IllegalArgumentException e) {
